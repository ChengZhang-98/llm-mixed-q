...
quant_config=$work_dir/experiments/asplos/configs/quantize/block_size/block_fp_6bit.toml
batch_size=4
save_dir=$work_dir/checkpoints/asplos/block_size_6bit/${model_name//\//_}
