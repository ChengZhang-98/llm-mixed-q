...
run_dir=$work_dir/experiments/asplos/mixed_bfp_acc_mem
cd $run_dir
echo ========== Running Llama-160M SST2 ==========
search_tag=$1
search_config=$2

save_dir=$work_dir/checkpoints/asplos/mixed_bfp_acc_mem/llama_160m_sst2/$search_tag && mkdir -p $save_dir
model_arch=llama
task=sst2
