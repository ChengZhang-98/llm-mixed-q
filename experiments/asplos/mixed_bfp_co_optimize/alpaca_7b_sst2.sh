...
if [ -z $2 ]; then
    search_config=$work_dir/experiments/asplos/configs/search/bfp_co_optimize/alpaca_7b_sst2.toml
...
save_dir=$work_dir/checkpoints/asplos/mixed_bfp_co_optimize/alpaca_7b/$search_tag && mkdir -p $save_dir
model_arch=llama
tasks=sst
