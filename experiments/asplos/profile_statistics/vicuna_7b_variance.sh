...
save_dir=$work_dir/checkpoints/asplos/profile_statistics/vicuna_7b_wikitext2_var/$profile_tag && mkdir -p $save_dir
...
max_length=2048
num_samples=32
act_stats="variance_online"
weight_stats="variance_online"
