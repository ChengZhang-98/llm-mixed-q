...
search_tag=$1
save_dir=$work_dir/checkpoints/asplos/search/bert_base_sst2/$search_tag
mkdir -p $save_dir

model_arch=bert
task=sst2
search_config=$work_dir/experiments/asplos/configs/search/samplers/bert_base_sst2_random.toml
