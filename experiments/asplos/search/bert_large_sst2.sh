...
#SBATCH --output=log_bert-large-uncased_search_sst2.txt
#SBATCH --job-name=bert-large-uncased_search_sst2
...
search_tag=$1
save_dir=$run_dir/bert_large_sst2/$search_tag
mkdir -p $save_dir

model_arch=bert
task=sst2
search_config=$work_dir/experiments/asplos/configs/search/bert_large_sst2.toml
ckpt=$work_dir/experiments/asplos/fine_tune/bert_large_sst2
batch_size=128
max_length=196
