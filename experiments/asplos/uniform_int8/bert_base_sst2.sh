...
echo "🚀 Running Uniform Int8 BERT-base on SST2"
model_arch=bert
model_name=$work_dir/checkpoints/asplos/fine_tune/bert_base_sst2
save_tag=$1
stat_toml=$work_dir/checkpoints/asplos/profile_statistics/bert_base_sst2/fp32/statistic_profile.toml
save_dir=$work_dir/checkpoints/asplos/uniform_int8/bert_base_sst2/$save_tag && mkdir -p $save_dir
