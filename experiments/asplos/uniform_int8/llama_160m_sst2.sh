...
echo "🚀 Running Uniform Int8 Llama-160M on SST2"
model_arch=llama
model_name=$work_dir/checkpoints/asplos/fine_tune/llama_160m_sst2
save_tag=$1
stat_toml=$work_dir/checkpoints/asplos/profile_statistics/llama_160m_sst2/fp32/statistic_profile.toml
save_dir=$work_dir/checkpoints/asplos/uniform_int8/llama_160m_sst2/$save_tag && mkdir -p $save_dir
