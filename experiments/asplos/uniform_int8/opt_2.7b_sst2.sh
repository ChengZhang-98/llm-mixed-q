...
echo "🚀 Running Uniform Int8 OPT-2.7B on Wikitext2"
model_arch=opt
model_name=facebook/opt-2.7b
save_tag=$1
stat_toml=$work_dir/checkpoints/asplos/profile_statistics/opt_2.7b_wikitext2/fp32/statistic_profile.toml
save_dir=$work_dir/checkpoints/asplos/uniform_int8/opt_2.7b/$save_tag && mkdir -p $save_dir
