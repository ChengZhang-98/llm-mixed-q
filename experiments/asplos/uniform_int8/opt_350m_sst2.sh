...
echo "🚀 Running Uniform Int8 SST2"
model_arch=opt
model_name=$work_dir/checkpoints/asplos/fine_tune/opt_350m_sst2
save_tag=$1
stat_toml=$work_dir/checkpoints/asplos/profile_statistics/opt_350m_sst2/fp32/statistic_profile.toml
save_dir=$work_dir/checkpoints/asplos/uniform_int8/opt_350m_sst2/$save_tag && mkdir -p $save_dir
