...
echo "🚀 Running Uniform Int8 Vicuna-7B on Wikitext2"
model_arch=llama
model_name=lmsys/vicuna-7b-v1.3
save_tag=$1
stat_toml=$work_dir/checkpoints/asplos/profile_statistics/vicuna_7b_wikitext2/fp32/statistic_profile.toml
save_dir=$work_dir/checkpoints/asplos/uniform_int8/vicuna_7b/$save_tag && mkdir -p $save_dir
