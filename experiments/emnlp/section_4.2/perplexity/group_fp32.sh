...
quant_config=$work_dir/experiments/emnlp/configs/quantize/fp32.toml

# ========= 7b =========
# declare -a MODEL_NAMES=("huggyllama/llama-7b" "lmsys/vicuna-7b-v1.3" "Cheng98/Acapla-7b")

# for model_name in "${MODEL_NAMES[@]}"; do
#     bash $run_dir/eval_wikitext2.sh llama $model_name $quant_config fp32
...
for model_name in "${MODEL_NAMES[@]}"; do
    bash $run_dir/eval_wikitext2.sh llama $model_name $quant_config fp32 1 \
...
# declare -a MODEL_NAMES=("huggyllama/llama-30b")
