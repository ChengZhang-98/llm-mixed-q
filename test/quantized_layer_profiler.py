...
def test_profiler():
    ...
    print(
        profile_matmul_layer(
            quant_config_int["matmul"], data_in_0_size=(1, 10), data_in_1_size=(10, 10)
        )
    )
    print(
        profile_linear_layer(
            quant_config_block_fp["linear"],
            in_features=10,
            out_features=10,
            bias=True,
            batch_size=1,
    ...
    print(
        profile_matmul_layer(
            quant_config_block_fp["matmul"],
            data_in_0_size=(1, 10),
            data_in_1_size=(10, 10),
        )
    )
